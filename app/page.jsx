      ...
      <section id='contact' className='flex flex-col justify-center min-h-screen h-[100%] bg-blue-300'>
        ...
        <div className='flex flex-row flex-wrap justify-center mt-10 gap-32'>
          <div className='flex flex-col justify-between'>
            <a href='https://linkedin.com/in/lucasmah' alt='linkedin' target='_blank' className='flex items-center justify-center' rel='noreferrer'>
              <Image src='/linkedin_icon.png' height={100} width={100} alt='logo' />
            </a>
            <p className='contactText'>Linkedin</p>
          </div>
          <div className='flex flex-col justify-between'>
            <a href='https://github.com/lucastmah' alt='github' target='_blank' className='flex items-center justify-center' rel='noreferrer'>
              <Image src='/github_icon.png' height={100} width={100} alt='logo' />
            </a>
            <p className='contactText'>GitHub</p>
          </div>
          <div className='flex flex-col justify-between'>
            <a href='mailto:lucasmah@outlook.com' alt='lucasmah@outlook.com' target='_blank' className='flex items-center justify-center' rel='noreferrer'>
