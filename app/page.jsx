      ...
      <Section id='projects' color='bg-blue-400'>
        <div className='m-auto'>
          ...
          <div className='flex flex-row flex-wrap justify-center max-w-[800px] gap-32 mt-10'>
            <Tile icon='/cart_icon.png' name='Boneyard of the Innocent' /> 
            <Tile icon='/health_icon.png' name='Skip To Clinic'/>
            <Tile icon='/shield_icon.png' name='Snowfort 2024' />
            <Tile icon='/controller_icon.png' name='Past Your Peak' />
          </div>
        </div>
      </Section>
